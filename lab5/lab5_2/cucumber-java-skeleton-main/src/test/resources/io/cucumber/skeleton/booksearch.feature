Feature: Book search
  ...
  Background: 
    Given a book with the title 'One good book', written by 'Anonymous', published in 2013-03-14, with the category 'Romance'
      And a book with the title 'Some other book', written by 'Tim Tomson', published in 2014-08-23, with the category 'Romance'
